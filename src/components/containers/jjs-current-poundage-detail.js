...
import { getJjsCurrentMonthPoundageData } from '../../api/app-interaction-api.js';

const JjsCurrentPoundageContainer = React.createClass({
	getInitialState(){
		return {
			jjsid: '',
			fees_sum: '',
	...
	componentDidMount(){
		const _this = this;
		getJjsCurrentMonthPoundageData({jjs: this.state.jjsid},function(info){
...
export default JjsCurrentPoundageContainer;

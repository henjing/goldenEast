...
const shenWenSuoMicroBoardReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_SHENWENSUO_MICRO_BOARD :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_SHENWENSUO_MICRO_BOARD_SEARCH :
...
export default shenWenSuoMicroBoardReducer;
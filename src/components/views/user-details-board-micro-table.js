...
const UserListTable = React.createClass({
    ...
    render(){
        ...
        if (dataSource.exchange_type == 'shenwen_weipan'){
            DetailsRoute = 'shenwensuo_wp';
        }else if (dataSource.exchange_type == 'jishang_weipan'){
            DetailsRoute = 'jishang_wp';
        }else {
            DetailsRoute = 'yueguoji_wp';
        };
        columns.push(
            {
                title: '操作',

...
const boardMarketBrokerageReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_BOARD_MARKET_BROKERAGE :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_BOARD_MARKET_BROKERAGE_SEARCH :
...
export default boardMarketBrokerageReducer;
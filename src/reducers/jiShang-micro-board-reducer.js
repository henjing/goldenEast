...
const jiShangMicroBoardReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_JISHANG_MICRO_BOARD :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_JISHANG_MICRO_BOARD_SEARCH :
...
export default jiShangMicroBoardReducer;
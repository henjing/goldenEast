...
const jiShangPostCardReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_JISHANG_POST_CARD :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_JISHANG_POST_CARD_SEARCH :
...
export default jiShangPostCardReducer;
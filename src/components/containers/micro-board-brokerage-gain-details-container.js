...
import { updateMicroBoardBrokerageUserDetailSearch } from '../../actions/app-interaction-actions';
import { getMicroBoardUserDetailData } from '../../api/app-interaction-api';
...
var BoardMarketBrokerageGainDetailsContainer = React.createClass({
    ...
    submitSearch() {
        getMicroBoardUserDetailData(this.props.searchState);
    },

...
const microBoardBrokerageReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_MICRO_BOARD_BROKERAGE :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_MICRO_BOARD_BROKERAGE_SEARCH :
...
export default microBoardBrokerageReducer;
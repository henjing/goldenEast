...
import InfoAssetsAllotDetails from '../views/InfoAssetsAllotDetails';

const RangePicker = DatePicker.RangePicker;

var InfoAssetsAllotContainer = React.createClass({
    render(){
        return (
            <div>
...
module.exports = InfoAssetsAllotContainer;

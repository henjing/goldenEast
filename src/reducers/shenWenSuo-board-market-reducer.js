...
const shenWenSuoBoardMarketReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_SHENWENSUO_BOARD_MARKET :
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_SHENWENSUO_BOARD_MARKET_SEARCH :
...
export default shenWenSuoBoardMarketReducer;
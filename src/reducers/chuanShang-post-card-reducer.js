...
const chuanShangPostCardReducer = function (state = initialState, action) {
    
    switch (action.type) {
        
        case types.UPDATE_CHUANSHANG_POST_CARD:
            return Object.assign({}, state, { dataState : {...action.info }});
        
        case types.UPDATE_CHUANSHANG_POST_CARD_SEARCH :
...
export default chuanShangPostCardReducer;